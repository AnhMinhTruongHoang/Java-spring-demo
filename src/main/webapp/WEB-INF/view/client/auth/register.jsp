                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    ...
                                    <form:form method="post" action="/register" modelAttribute="registers">
                                        ...
                                        <div class="form-floating mb-3">
                                            <!-- Removed duplicate 'path' attribute -->
                                            <form:input class="form-control ${not empty errorEmail ? 'is-invalid' : '' }"
                                                type="email" placeholder="email@example.com" path="email" />
                                            <label>Email</label>
                                            ${errorEmail}
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <form:input class="form-control" type="password"
                                                        placeholder="Confirm password" path="repassword" />
